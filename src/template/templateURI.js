...
export const UNSAVE_LOAD=`${TEMPLATE_URL}/unsave/load`;
//post
export const UNSAVE_TODO_INSERT=`${TEMPLATE_URL}/todo/insert`;
export const REVIEW_INSERT=`${TEMPLATE_URL}/review/insert`;
//put
export const UNSAVE_UP_LOAD=`${TEMPLATE_URL}/unsave/upload`;
