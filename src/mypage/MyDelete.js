...
function MyDelete({myprofile, isSocial}) {
        ...
        <div className="App">
            <div class="container p-5">
                ...
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModa7"
                        style={{float: 'right', marginRight: '-3px', borderRadius: '100px'}}>
                    회원 탈퇴
                </button>

                <div class="modal fade" id="exampleModa7" tabindex="-1" aria-labelledby="exampleModalLabel"
                     aria-hidden="true">
                                ...
                                <form>
                                    <div class="mb-3">
                                        ...
                                        <div className="delete_user_content">
                                            <div id="delete_outer" style={{marginTop: '30px',}}>
                                                <div style={{marginTop: '25px'}}>
                                                    <img src={myprofile?.photo?.filePath + myprofile?.photo?.changeName}
                                                         style={{
                                                             marginLeft: '0px',
                                                             width: '60px',
                                                             height: '60px',
                                                             marginTop: '-17px'
                                                         }} className="profileImg"></img><span
                                                    style={{marginTop: '-40px', marginLeft: '7px'}}><b style={{
                                                    fontFamily: 'NanumGothic-Regular',
                                                    fontSize: '25px'
                                                }}>{myprofile?.nickName}</b></span>
                                        ...
                                        회원탈퇴 버튼을 누르면 <b style={{color: 'red'}}>사진 , 댓글 , 좋아요 친구 관계를 포함한 모든 데이터가 영구적으로 삭제</b>되어 복구할 수 없게 됩니다. 이후 다른 Lemong계정을 만들 때 같은 사용자 이름으로 다시 가입할 수 없습니다.
                                            ...
                                            <br/>
                                            <p style={{fontSize: '23px', fontFamily: 'NanumGothic-Regular'}}><b>🗸
                                                회원탈퇴</b></p>
                                    ...
                                    {!isSocial && <>
                                          <label for="exampleInputEmail1" class="form-label"
                                               style={{fontFamily: 'SourceSansPro-Light'}}><b>Password</b></label>
                                        <input type="password" class="form-control" name="passwordCheck1"
                                               onChange={handleInput} style={{borderRadius: '0'}}/>
                                        <div class="mb-3">
                                            <label for="exampleInputPassword1" class="form-label"
                                                   style={{fontFamily: 'SourceSansPro-Light'}}><b>Password
                                                Check</b></label>
                                            <input type="password" class="form-control" name="passwordCheck2"
                                                   onChange={handleInput} style={{borderRadius: '0'}}/>
                                        </div>
                                    </>
                                    }
                                    <br/>
                                    {(pwdcheck.passwordCheck1 === pwdcheck.passwordCheck2 || isSocial) &&
