...
function MyFollowCount(){
    ...
    return(
        <div className="followCount">
            <span>팔로워 <p style={{marginLeft:'20px'}} data-bs-toggle="modal" data-bs-target="#exampleModal1" onClick={ShowMyFollower}>{myfollow?.count}</p></span>
            <div className="App">
            <div class="container p-5">
             ...
             <div class="modal-dialog" style={{margin:'auto' , marginTop:'50px'}}>
                <div class="modal-content" style={{width:'600px' , height:'800px' , borderRadius:'0'}}>
                   ...
                   <div class="modal-dialog" style={{marginLeft:'30px'}}>
