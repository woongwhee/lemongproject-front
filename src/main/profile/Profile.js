...
function Profile() {
    ...
    return (
        ...
        <div className='pro-intro'>{profile.profileComment}</div> */}
            ...
            <div onClick={selectUserNo} className='react-calendar2' style={{
                ...
                <div className='pro-nic'><b><p style={{marginTop: '35px', fontSize: '18px'}}>{profile.nickName}</p></b>
                </div>
                <div className='pro-following-count' style={{
                    marginTop: '65px',
                    marginLeft: '-135px',
                    height: '30px',
                ...
                <div className='pro-intro'><p style={{
                    float: 'left',
                    width: '70%',
                    marginTop: '0px',
                    paddingLeft: '28px',
